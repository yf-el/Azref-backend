locals {
  name_prefix = "${var.project_name}-${var.env}-agent"
  log_group   = "/${var.project_name}/${var.env}/agent"
}
...
data "aws_iam_policy_document" "ecr_pull" {
  ...
  statement {
    ...
    resources = [data.terraform_remote_state.platform.outputs.agent_ecr_repository_arn]
  }
}
